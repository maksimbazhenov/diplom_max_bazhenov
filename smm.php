      ...
      <div class="row align-items-center">
        <div class="col-lg-7 col-md-6">
          <div class="slider_text">
            <h3 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".2s">SMM-продвижение </h3>
            <h4 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".2s">Раздел в разработке </h4>
          </div>
        </div>
      </div>
    </div>
